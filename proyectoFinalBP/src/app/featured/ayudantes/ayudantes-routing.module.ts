...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'assistants', component: AssistantsComponent, canActivate: [AuthCheckGuard],
      },
      {
        path: 'assistants/:id', component: AssistantsDetailComponent, canActivate: [AuthCheckGuard],
      }
    ]
  }
];
